Ponder.registry((event) => {
    event.create("mel:addition_sigil").scene("addition_ritual", "聚合仪式", "mel:addition_ritual", (scene, util) => {
        scene.showStructure();

        let sigil = scene.world.createItemEntity([3.5, 4, 3.5], [0, 0, 0], "mel:addition_sigil");
        scene.idle(40);
        ...
        scene.world.setBlocks([1, 1, 1, 5, 1, 5], Block.getBlock("botania:infused_grass").defaultBlockState(), true);
