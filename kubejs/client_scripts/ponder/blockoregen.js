Ponder.registry((event) => {
    event.create("mel:gensousitu_bucket").scene("-", "-", (scene, util) => {
        scene.showStructure();
        scene.idle(10);
        scene.showControls(10, [3.8, 1.5, 2.8], "down").rightClick().withItem("iron_block");
        scene.world.setBlocks([3, 1, 2], "iron_block", true);
        scene.idle(20);
        scene.showControls(10, [0.8, 1.5, 2.8], "down").rightClick().withItem("mel:gensousitu_bucket");
        scene.world.setBlocks([0, 1, 2], "mel:gensousitu", true);
        scene.idle(10);
        scene.world.setBlocks([1, 1, 2], "mel:gensousitu", true);
