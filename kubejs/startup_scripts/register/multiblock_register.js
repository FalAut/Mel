StartupEvents.postInit((event) => {
    ...
    $PatchouliAPI.registerMultiblock(
        ...
        $PatchouliAPI.makeMultiblock(
            ...
            new $Character("0"),
            Block.getBlock("mel:ancient_aura_generator_core")
        )
    );

    $PatchouliAPI.registerMultiblock(
        "mel:division_sigil_activation_ritual",
        $PatchouliAPI.makeMultiblock(
            [
